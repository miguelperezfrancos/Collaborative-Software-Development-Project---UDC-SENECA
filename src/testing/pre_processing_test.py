...
class TestDataManager(unittest.TestCase):
    ...
    def test_detect_nan(self):
        ...
        self.data_manager.data = self.test_data
        self.assertEqual(self.data_manager.detect(
            'col1'), 1)  # Una fila con NaN
        self.assertEqual(self.data_manager.detect(
            'col2'), 1)  # Una fila con NaN
    ...
    def test_replace_nan_mean(self):
        ...
        self.assertTrue(
            any(self.data_manager.data['col1'] == expected_mean_col1))
        self.assertTrue(
            any(self.data_manager.data['col2'] == expected_mean_col2))
    ...
    def test_replace_nan_median(self):
        ...
        self.assertTrue(
            any(self.data_manager.data['col1'] == expected_median_col1))
        self.assertTrue(
            any(self.data_manager.data['col2'] == expected_median_col2))
    ...
    def test_replace_nan_constant(self):
        ...
        self.assertTrue(
            all(self.data_manager.data.loc[nan_mask_col1, 'col1'] == constant_value))
        self.assertTrue(
            all(self.data_manager.data.loc[nan_mask_col2, 'col2'] == constant_value))
    ...
    def test_replace_non_numeric_column(self):
        ...
        pd.testing.assert_series_equal(
            self.data_manager.data['col3'], original_values)
